...
import TechNinjas.LocaFacil.DTO.CredDTO;
...
import java.util.Date;
    ...
    public class AuthenticationJWTFilter extends UsernamePasswordAuthenticationFilter {
        ...
        public AuthenticationJWTFilter(AuthenticationManager authenticationManager, JWTUtil jwtUtil) {
        ...
        public Authentication attemptAuthentication(HttpServletRequest request,
            ...
            /* getInputStream() Recupera o corpo da solicitação como dados
               ...
               pode ser chamado para ler o corpo */
                CredDTO creds = new ObjectMapper().readValue(request.getInputStream(), CredDTO.class);
        ...
        protected void successfulAuthentication(HttpServletRequest request,
            ...
            String username = ((UsuarioData) authResult.getPrincipal()).getUsername();
